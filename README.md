...
A full-stack web application that enables users to upload PDF documents and ask questions about their content using AI-powered Retrieval-Augmented Generation (RAG). Built with FastAPI backend, React frontend, and PostgreSQL with PGVector for efficient vector storage.
...
- **Tabbed Interface**: Clean navigation between upload and chat functions
...
- **AI/ML**: Google Gemini Pro for language generation, HuggingFace embeddings
...
│ • Responsive UI │    │ • API Endpoints │    │ • Document Chunks│
└─────────────────┘    └─────────────────┘    └─────────────────┘
```
